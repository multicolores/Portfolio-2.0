            ...
            <motion.section       
               ...
               <motion.div 
                ...
                <p className="description">This site is largely inspired by an existing site design but the design of this site
                    ...
                    <a href="https://github.com/multicolores/Restaurant-site" target="_blank" onMouseEnter={()=> {setCursorHovered(true); setcursorHovered_clickable(true)}} onMouseLeave={()=> {setCursorHovered(false); setcursorHovered_clickable(false)}}> <span>See code</span></a>
