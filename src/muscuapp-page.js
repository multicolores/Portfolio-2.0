    ...
    <>
      ...
      >
        ...
        <p className="description">
          Application pour suivre ses entraînements de musculation FullStack
          réalisée avec ReactJs, NodeJS et une base de données Mongodb
          <a
          ...
          <a
            href="https://github.com/multicolores/muscu-app-react"
            target="_blank"
            rel="noopener noreferrer"
            onMouseEnter={() => {
              setCursorHovered(true);
