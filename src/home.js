    ...
    <>
      ...
      >
        ...
        {/* <div className="langue">
          ...
          >
            <span className="active_langue">fr</span>
            <span> en</span>
          </Link>
        </div> */}
          ...
          <div className="paragraphe">
            <div className="TextFadeIn" ref={text}>
              <p>
                ...
                actuellement en licence "Conception et Développement
                d’Application Web et Mobile".
              </p>
              <p>
                Passionné de développement web, j'essaie d'apprendre un maximum
      ...
      <p>J'essaie d'amener à mes sites une touche d'originalité permettant une expérience utilisateur caractéristique dont ils se souviendront.</p> */}
            ...
            <i class="fab fa-node TextFadeIn" ref={text}></i>
            <i class="fab fa-angular TextFadeIn" ref={text}></i>
      ...
      <h2>Desgin</h2>
        ...
        <section className="a_propos">
          <div>
            <p>
              Je n'ai pas encore accumulé beaucoup d'expérience professionnelle
              mais je suis passioné par la création de site web depuis plusieurs
              années déjà. Je m'implique dans tous les projets que je réalise
              car je souhaite toujours m'améliorer.
            </p>
            <p>
              Je suis toujours partant pour réaliser un projet, n'hésiter pas a
              me contacter si vous pensez que l'on pourrais créer quelque chose
              ensemble.
            </p>
          </div>
        </section>
