    ...
    return(
        <>
            <motion.section       
                ...
                <p className="description">Voici différents design de header de site web que j'ai réaliser au cours d'un challenge que je me suis donner qui 
                consister en la réalisation tout les jours, en 1h, d'une page d'accueil d'un site sur un thème aléatoire. 
               <p>Challenge qui ma énormément fait progresser en design de page web.</p> 
